      ...
      <main>
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            {user ? (<div className="user-info"><img src={user.avatar} alt="Avatar do usuário" /><span id="user-name">{user.name}</span></div>) : (<span>Para enviar uma pergunta, <button>faça seu login.</button></span>)}
          ...
          return (
            ...
            >
              {!question.isAnswered && (<button
                className={`like-button ${question.likeId !== undefined ? 'liked' : ''}`}
                type="button"
